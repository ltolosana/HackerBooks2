...
// Make changes to LMTBook.m instead.

#import "_LMTBook.h"

const struct LMTBookAttributes LMTBookAttributes = {
	.isFavorite = @"isFavorite",
	.title = @"title",
};

const struct LMTBookRelationships LMTBookRelationships = {
...
@implementation LMTBookID
@end

@implementation _LMTBook
...
- (LMTBookID*)objectID {
	return (LMTBookID*)[super objectID];
}
